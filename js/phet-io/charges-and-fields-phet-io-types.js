...
window.phet.phetio.phetioTypes = assert &&
  {
    ...
    "FunctionIO.(ChargedParticleIO)=>VoidIO": {
      ...
      "supertype": "ParametricTypeImplIO.<ChargedParticleIO, VoidIO>",
    ...
    "FunctionIO.(ElectricPotentialLineIO)=>VoidIO": {
      ...
      "supertype": "ParametricTypeImplIO.<ElectricPotentialLineIO, VoidIO>",
    ...
    "ObservableArrayIO.<ChargedParticleIO>": {
      ...
      "supertype": "ParametricTypeImplIO.<ChargedParticleIO>",
    ...
    "ObservableArrayIO.<ElectricPotentialLineIO>": {
      ...
      "supertype": "ParametricTypeImplIO.<ElectricPotentialLineIO>",
    ...
    "ParametricTypeImplIO.<ChargedParticleIO, VoidIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeImplIO.<ChargedParticleIO, VoidIO>"
    },
    "ParametricTypeImplIO.<ChargedParticleIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeImplIO.<ChargedParticleIO>"
    },
    ...
    "ParametricTypeImplIO.<ElectricPotentialLineIO, VoidIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeImplIO.<ElectricPotentialLineIO, VoidIO>"
    },
    "ParametricTypeImplIO.<ElectricPotentialLineIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeImplIO.<ElectricPotentialLineIO>"
    },

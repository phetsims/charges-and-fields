...
window.phet.phetio.phetioTypes = assert &&
  {
    ...
    "FunctionIO.(ElectricPotentialLineIO)=>VoidIO": {
      ...
      "supertype": "ParametricTypeIO.<ElectricPotentialLineIO, VoidIO>",
    ...
    "ObservableArrayIO.<ElectricPotentialLineIO>": {
      ...
      "supertype": "ParametricTypeIO.<ElectricPotentialLineIO>",
    ...
    "ParametricTypeIO.<ChargedParticleIO, VoidIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeIO.<ChargedParticleIO, VoidIO>"
    },
    "ParametricTypeIO.<ChargedParticleIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeIO.<ChargedParticleIO>"
    },
    ...
    "ParametricTypeIO.<ElectricPotentialLineIO, VoidIO>": {
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeIO.<ElectricPotentialLineIO, VoidIO>"
    },
    "ParametricTypeIO.<ElectricPotentialLineIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeIO.<ElectricPotentialLineIO>"
    },

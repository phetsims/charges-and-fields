...
define(function (require) {
    ...
    function ChargesAndFieldsScreenView(model) {
        ...
        var tape_options = {
            textColor: ChargesAndFieldsColors.measuringTapeText.toCSS(),
        ...
        //ChargesAndFieldsColors.linkAttribute('measuringTapeText', measuringTape, 'textColor');
        ...
        controlPanel.top = 20;
        grid.centerX = this.layoutBounds.centerX;
        grid.centerY = this.layoutBounds.centerY;

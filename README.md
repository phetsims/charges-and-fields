...
(5) Open in the browser: `http://localhost/charges-and-fields/charges-and-fields_en.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
